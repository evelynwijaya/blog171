        ...
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="owl-carousel ftco-owl">
              ...
              <div class="item">
                <div class="media d-block mb-4 text-center ftco-media ftco-animate border-0">
                  <img src="asset/images/offer_3.jpg" alt="Free Template by Free-Template.co" class="img-fluid">
                  <div class="media-body p-md-5 p-4">
                    <h5 class="text-primary">$39.50</h5>
                ...
                <div class="row">
                  <div class="col-md-6 ftco-animate">
                    <div class="media menu-item">
                      <img class="mr-3" src="asset/images/menu_1.jpg" class="img-fluid" alt="Free Template by Free-Template.co">
                    ...
                    <div class="media menu-item">
                      <img class="mr-3" src="asset/images/menu_2.jpg" class="img-fluid" alt="Free Template by Free-Template.co">
                      <div class="media-body">
                    ...
                    <div class="media menu-item">
                      <img class="mr-3" src="asset/images/menu_3.jpg" class="img-fluid" alt="Free Template by Free-Template.co">
                      <div class="media-body">
